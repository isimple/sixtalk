...
{    
	...
	chat->mtext = gtk_text_buffer_create_tag(buffer, "mtext", "foreground", "black", "size", 10 * PANGO_SCALE, NULL);

	chat->binfo = gtk_text_buffer_create_tag(buffer, "binfo", "foreground", "red", "size", 8 * PANGO_SCALE, NULL);
	chat->btext = gtk_text_buffer_create_tag(buffer, "btext", "foreground", "black", "size", 10 * PANGO_SCALE, NULL);
}
